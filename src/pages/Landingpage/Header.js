        ...
        <header  className='bg-primary min-h-screen lg:px-28  px-4'>
            ...
            <div className='grid md:grid-cols-2 relative z-50  gap-4  pt-16 '>
                 <div data-aos="zoom-in" className=' '>
                    <h1 className='text-white text-4xl lg:text-7xl font-bold'>Your perfect<br />Banking Partner.</h1>
                    ...
                    <div className='grid grid-cols-3 lg:w-[95%]'>
                        ...
                        <BankAdvantage advantage="Loan Interest Rate" score="-15%" />
                        <BankAdvantage advantage="Satisfied Customers" score="3M+" />
                    </div>
